			...
			<footer className="footer">
				<div className="footer__logo-box">
					...
					<picture className="footer__logo">
						<source srcSet={`${require('assets/img/logo-green-small-1x.png')} 1x, ${require('assets/img/logo-green-small-2x.png')} 2x`}
						        media="(max-width: 37.5em)" />
							<img srcSet={`${require('assets/img/logo-green-1x.png')} 1x, ${require('assets/img/logo-green-2x.png')} 2x`} alt="Full logo"
					...
					<div className="col-1-of-2">
						<p className="footer__copyright">
							Built by <a href="#" className="footer__link">Jonas Schmedtmann</a> for his online course <a href="#"
							                                                                                             className="footer__link">Advanced
							CSS and Sass</a>.
